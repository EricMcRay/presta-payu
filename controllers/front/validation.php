...
class estPayValidationModuleFrontController extends ModuleFrontController {
    ...
    public function postProcess() {
		...
		');
                        ...
                        Tools::redirect('index.php?fc=module&module=estpay&controller=payment?fail=1&amount=' . $totalAmount . '&err=' . $i . $parsedXML->RETURN_MESSAGE);
                    }
                }
            } else {
                $hata = "Ltfen Btn Alanlar Doldurunuz";
                Tools::redirect('index.php?fc=module&module=estpay&controller=payment?fail=1&amount=' . $totalAmount . '&err=' . $hata);
            }
        } else {
            $hata = "Ltfen Btn Alanlar Doldurunuz";
            Tools::redirect('index.php?fc=module&module=estpay&controller=payment?fail=1&amount=' . $totalAmount . '&err=' . $hata);
